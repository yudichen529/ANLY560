...
vaccine[['ticker','a']]= vaccine.variable_x.str.split(".",expand=True)
vaccine[['c','b']]= vaccine.variable_y.str.split(".",expand=True)
vaccine = vaccine.query('ticker == c')
vaccine = vaccine.drop(['variable_x','variable_y','a','b','c'],axis=1)
...
airline[['ticker','a']]= airline.variable_x.str.split(".",expand=True)
airline[['c','b']]= airline.variable_y.str.split(".",expand=True)
airline = airline.query('ticker == c')
airline = airline.drop(['variable_x','variable_y','a','b','c'],axis=1)
...
hotel[['ticker','a']]= hotel.variable_x.str.split(".",expand=True)
hotel[['c','b']]= hotel.variable_y.str.split(".",expand=True)
hotel = hotel.query('ticker == c')
hotel = hotel.drop(['variable_x','variable_y','a','b','c'],axis=1)
